...
function Main() {
  ...
  <div className='relative h-[60vh] overflow-hidden'>
    ...
    <div className='flex rounded-full border bg-navbar h-fit w-fit mt-4 px-6 mx-auto'>
        ...
        <div className='font-semiboldflex justify-left flex-row gap-8 my-4 mx-8'>
        Fact
    ...
    <div className='flex flex-row h-60 w-auto mx-60 my-28'>
    <div className='flex bg-[#1C1C1C] flex-col h-60 w-[200px] mx-auto justify-between rounded-xl drop-shadow-xl px-5 ' >
        <div style={{ fontSize: '12px' }} className='font-bold mx-auto my-4 text-center'>Can Z-Sharp Build My Raw Idea?</div>
        <img src='/images/homepage/idea.svg' className='h-28 rounded-tl-[30px]'/>
        <div style={{ fontSize: '10px' }} className='mx-auto my-auto text-center'>Yes, Z-Sharp can sharpen your raw idea until it becomes worthy of implementation.</div>
      </div>
      <div className='flex bg-[#1C1C1C] flex-col h-60 w-[200px] mx-auto justify-between rounded-xl drop-shadow-xl  px-5 ' >
        <div style={{ fontSize: '12px' }} className='font-bold mx-auto my-4 text-center'>Can Z-Sharp Analyze My Selling and Market Potential?</div>
        <img src='/images/homepage/analytics.svg' className='h-28 rounded-tl-[30px] '/>
        <div style={{ fontSize: '10px' }} className='mx-auto my-auto text-center'>Yes, Z-Sharp can analyze your selling and market potential.</div>
      </div>
      <div className='flex bg-[#1C1C1C] flex-col h-60 w-[200px] mx-auto justify-between rounded-xl drop-shadow-xl  px-5 ' >
        <div style={{ fontSize: '12px' }} className='font-bold mx-auto my-4 text-center'>Can Z-Sharp Provide Business Consultation?</div>
        <img src='/images/homepage/presentation.svg' className='h-28 rounded-tl-[30px] '/>
        <div style={{ fontSize: '10px' }} className='mx-auto my-auto text-center'>Yes, we will provide business consultation to you to the best of our ability through our talented consultants.</div>
      </div>
    </div>
    </>
  );
